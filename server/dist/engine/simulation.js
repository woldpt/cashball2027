...
exports.simulateHalfTime = simulateHalfTime;
const FORMATION_ATT_FACTOR = {
    "4-2-4": 1.15,
    "3-4-3": 1.12,
    "4-3-3": 1.08,
    "4-4-2": 1.00,
...
const STYLE_ATT_FACTOR = {
    "DEFENSIVO": 0.85,
    "EQUILIBRADO": 1.00,
    "OFENSIVO": 1.15
};
function getAvg(players, pos) {
...
function calculateOffensivePower(team, opponentStyle) {
...
function calculateDefensivePower(team) {
...
function simulateHalfTime(teamA, teamB, refereeInclination, // positive pushes Team A, negative Team B
minutes = 45) {
    ...
    if (teamB.isHome)
        ...
        probMinuteB *= 0.95;
    const getAggressivenessAvg = (team) => {
